//============================================================================
// Name        : ADI_Homo_II.cpp
// Author      : Tong WANG
// Email       : tong.wang@nus.edu.sg
// Version     : v2.0 (2015-12-16)
// Copyright   : MIT License
// Description : code for ADI Model 1 (Homogeneous), case II (T > L + 1), state-dependent
//============================================================================
// Compile: [GCC] g++ -O3 -o ADI_Homo_II.exe ADI_Homo_II.cpp
//          [ICC] icpc -O3 -o ADI_Homo_II.exe ADI_Homo_II.cpp
//---------------------------------------------------------------------------
...
int main()
{
    ...
    //Open output file
    file.open("Result_ADI_Homo_II.txt", fstream::app|fstream::out);
    
    if (! file)
    {
        //if fail to open the file
        cerr << "can't open output file Result_ADI_Homo_II.txt!" << endl;
        exit(EXIT_FAILURE);
    }
